...
import { Activity, CalendarCheck, Bike, HeartPulse, NotebookPen, Repeat, TrendingUp, Settings as SettingsIcon, RotateCw } from 'lucide-react'
...
const PlanScreen = lazy(() => import('./features/plan/PlanScreen.jsx'))
      ...
      <main className="app-main" ref={mainRef}>
        <div className="content-width">
          ...
          <Suspense fallback={<p className="muted">Loading…</p>}>
            ...
            {screen === 'plan' && <PlanScreen {...shared} onNavigate={setScreen} />}
