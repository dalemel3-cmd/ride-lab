...
const PLAN_DAYS = [
  ...
  },
  {
    ...
    terrain: 'Off-Bike',
    notes: 'Core stability exercises (planks, bird-dogs) and hip flexor stretching. Prepare legs for weekend gravel volume. Check crank bolt torque — the left crank has come loose twice this study; check weekly from here, not just race week.',
    isMilestone: false,
  },
  {
    date: '2026-09-12',
  ...
  },
  {
    ...
    phaseName: 'Aerobic Calibration',
    type: 'endurance',
    title: 'Rough-Surface Handling Session',
    ...
    notes: 'Added after review: the real Big Sugar course is rocky Ozark backcountry, not smooth local gravel. This day trades volume for handling practice on the roughest surface you can reach — comfort with the bike moving under you on loose rock matters more here than distance.',
    isMilestone: false,
  },
  {
    date: '2026-09-20',
  ...
  },
  {
    ...
    notes: 'Fueling rehearsal, not just a distance day: ride with the actual bottles/food you plan to carry on race day, not just any bottle. 40g carbs/hr and 750ml fluid/hr as targets. Note any saddle pressure or fatigue points.',
    isMilestone: false,
  },
  {
    date: '2026-09-27',
  ...
  },
  {
    ...
    terrain: 'Full Gravel Race Course Profile (real course GPX if available)',
