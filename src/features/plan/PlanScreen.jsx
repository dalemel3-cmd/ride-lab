...
const PLAN_DAYS = [
  ...
  },
  {
    ...
    notes: 'Keep heart rate strictly capped inside Zone 2. Build stroke volume and mitochondrial density without systemic fatigue.',
    isMilestone: false,
  },
  {
    date: '2026-09-11',
    ...
    terrain: 'Off-Bike',
    notes: 'Core stability exercises (planks, bird-dogs) and hip flexor stretching. Prepare legs for weekend gravel volume.',
    isMilestone: false,
  },
  {
    date: '2026-09-12',
    ...
    phaseName: 'Load Absorption & Fit',
    type: 'endurance',
    title: 'Endurance Gravel & Comfort Check',
    targetDistance: '15–18 mi',
    targetDuration: '85 min',
    zoneKey: 2,
    zoneDesc: 'Zone 2 (Z3 on punchy climbs)',
    terrain: 'Rolling Gravel & Pavement',
    notes: 'Test saddle comfort past the 1-hour mark. Stay seated on gravel climbs; evaluate tyre grip and tyre pressure (32–36 psi).',
    isMilestone: false,
  },
  {
    date: '2026-09-13',
  ...
  },
  {
    ...
    phaseName: 'Aerobic Calibration',
    type: 'endurance',
    title: 'Gravel Endurance with Verified Zones',
    targetDistance: '18–20 mi',
    targetDuration: '95 min',
    zoneKey: 2,
    zoneDesc: 'Zone 2 (Calibrated)',
    terrain: 'Mixed Gravel & Country Roads',
    notes: 'Ride using newly tested LTHR Zone 2 boundaries. Practice drinking 1 bottle of water/electrolytes per hour.',
    isMilestone: false,
  },
  {
    date: '2026-09-20',
  ...
  },
  {
    ...
    phaseName: 'Aerobic Calibration',
    type: 'endurance',
    title: 'Overdistance Gravel Endurance',
    targetDistance: '20–22 mi',
    targetDuration: '1h50',
    zoneKey: 2,
    zoneDesc: 'Zone 2 (Paced)',
    terrain: 'Gravel & Rolling Hills',
    notes: 'Test race-day nutrition: consume 40g carbs/hr and 750ml fluid/hr. Note any saddle pressure or fatigue points.',
    isMilestone: false,
  },
  {
    date: '2026-09-27',
    ...
    zoneDesc: 'Rest',
    terrain: 'Off-Bike',
    notes: 'Full rest day. Phase 2 complete.',
    isMilestone: false,
  },
  ...
  },
  {
    ...
    zoneDesc: 'Rest',
    terrain: 'Off-Bike',
    notes: 'Rest. Check bike tyres, chain lubrication, and pack carb chews/drink mix for tomorrow’s dress rehearsal.',
    isMilestone: false,
  },
  {
    date: '2026-10-03',
    ...
    phaseName: 'Peak Volume & Rehearsal',
    type: 'rehearsal',
    title: 'Full Race Rehearsal: 25–28 Miles',
    targetDistance: '25–28 mi',
    targetDuration: '2h15',
    zoneKey: 2,
    zoneDesc: 'Zone 2 Flats / Zone 4 Climbs',
    terrain: 'Full Gravel Race Course Profile',
    notes: 'Dress rehearsal: wear exact race bibs, test race tyre pressure, eat 45g carbs/hr from minute 30, and cap climb efforts at Zone 4. Never blow up.',
    isMilestone: true,
  ...
  },
  {
    ...
    phaseName: 'Two-Stage Taper & Race Week',
    type: 'endurance',
    title: 'Taper Gravel Ride',
    targetDistance: '14–16 mi',
    targetDuration: '75 min',
    zoneKey: 2,
    zoneDesc: 'Zone 2 (Relaxed)',
    terrain: 'Gravel & Country Roads',
    notes: 'Crisp 14–16 miles. Practice feeling fast and relaxed on gravel with fresh legs.',
    isMilestone: false,
  },
  {
    date: '2026-10-11',
    ...
    zoneDesc: 'Rest',
    terrain: 'Off-Bike',
    notes: 'Rest and mental preparation.',
    isMilestone: false,
  },
  ...
  },
  {
    ...
    terrain: 'Off-Bike',
    notes: 'Check sealant levels, tyre condition, chain lube, and bolt torques. Rest your legs.',
    isMilestone: false,
  },
  {
    date: '2026-10-16',
    ...
    terrain: 'Paved / Trail',
    notes: '20-minute shakeout to ensure shifting and brakes are dialed. 2 × 30-sec race pace efforts. Pack race bottles, bibs, and shoes.',
    isMilestone: false,
  },
  {
    date: '2026-10-17',
